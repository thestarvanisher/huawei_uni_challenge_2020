...
public class Bag {
    ...
    public boolean isEmpty() {
        return this.items.size() == 1 && this.items.get(0) == null;
    }

    public Bag splitBag() {
        Bag bag_left = new Bag(this.items.size() - 1, Math.floorDiv(this.getSize(), 2));
        Bag bag_right = new Bag(this.items.size() - 1, Math.floorDiv(this.getSize(), 2));
